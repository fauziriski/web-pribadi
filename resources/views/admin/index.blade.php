                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="list-unstyled list-unstyled-border">
                            ...
                            <li class="media">
                                <img class="mr-3 rounded-circle" width="50" src="admin/assets/img/avatar/avatar-4.png"
                                    alt="avatar">
                                <div class="media-body">
                    ...
                    <div class="card-body">
                        <ul class="list-unstyled list-unstyled-border">
                            ...
                            <li class="media">
                                ...
                                <img class="mr-3 rounded-circle" width="50" src="admin/assets/img/avatar/avatar-5.png"
                                    alt="avatar">
                                <div class="media-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="font-weight-600"><img
                                                    src="admin/assets/img/avatar/avatar-1.png" alt="avatar" width="30"
